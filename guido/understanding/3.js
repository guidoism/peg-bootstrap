// This is from a template in a.peg
...
function parse_sentence(input, pos) {
    ...
    if (!state) {
        ...
        if (state) {
            ...
            if (state) var r = state.val;
            if (state) {
                if (state) state.val = (`// This is from a template in b.peg, variable r is next:
                ${r}
...
// This is from a template in a.peg, variable r is next:
// This is from a template in a.peg
